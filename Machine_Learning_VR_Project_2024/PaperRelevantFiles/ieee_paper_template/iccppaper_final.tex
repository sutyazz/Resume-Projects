...
A typical paper length in ICCP has been 6-8 pages (double column). This is a rough guideline for papers submitted to ICCP. However, there is no arbitrary strict maximum length imposed on ICCP papers. Reviewers will be instructed to weigh the contribution of a paper relative to its length.
