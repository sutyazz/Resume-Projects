...
# -----------------------------
time_step = 0.1 # 1 minute per frame
...
class FlightPath:
    ...
    def generate_path(self):
        ...
        travel_time = total_distance / self.speed  # in minutes
        ...
        self.metadata['sigma'] = 0.1 * self.metadata['expected_travel_time']  # Adjust as needed
...
def simulate():
    ...
    print(f"  Estimated Time of Arrival (ETA): {eta:.2f} minutes after midnight")
   ...
   # Generate traffic flights
    ...
    exp_time, var_time = compute_travel_time_stats(optimized_fp)
    eta = optimized_fp.start_time + exp_time
    print(f"\nUpdated Estimated Time of Arrival (ETA): {eta:.2f} minutes after midnight")
    print(f"Variance in Arrival Time: {var_time:.2f} (minutes^2)")
