...
def simulate():
    ...
    print(f"  Expected Travel Time: {optimized_fp.metadata['expected_travel_time']:.2f} minutes")
    print(f"  Variance in Travel Time: {var_time:.2f} (minutes^2)")
    ...
    target_time = float(input("Enter a target arrival time (in minutes, relative to your start time): "))
